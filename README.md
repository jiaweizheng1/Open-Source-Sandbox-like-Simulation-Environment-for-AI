...
With `train.py` open in vscode, start the application and immediately change the main window to the game opened in the unity editor or in the executable. You should see your PPO model trained using `PPO.py` playing the game.
